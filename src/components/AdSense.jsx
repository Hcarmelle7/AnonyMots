...
const AdSense = ({ 
  ...
  if (isDev) {
    // Premium animated placeholder for local development
    return (
      <div 
      ...
      >
        ...
        <p className="text-white/40 text-xs mt-1 max-w-[280px] leading-relaxed">
          Configure ton ID d'éditeur dans <code className="bg-white/10 px-1 py-0.5 rounded text-[10px] text-pink-300">index.html</code> pour afficher de vraies pubs.
        </p>
      </div>
    );
  }
